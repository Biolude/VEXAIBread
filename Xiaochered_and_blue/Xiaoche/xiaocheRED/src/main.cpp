...
// 驱动电机配置
motor LMoveMotorA = motor(PORT14, ratio18_1, false);
motor LMoveMotorB = motor(PORT15, ratio18_1, false);
motor_group LMove = motor_group(LMoveMotorA, LMoveMotorB);
motor RMoveMotorA = motor(PORT19, ratio18_1, true);
motor RMoveMotorB = motor(PORT20, ratio18_1, true);
...
gps GPS = gps(PORT6, -87.50, -100.00, mm, 180);
